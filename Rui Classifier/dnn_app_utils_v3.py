...
# def load_data():
#     train_dataset = h5py.File('datasets/rui_dataset.h5', "r")
#     train_set_x_orig = np.array(train_dataset["train_set_x"][:]) # your train set features
#     train_set_y_orig = np.array(train_dataset["train_set_y"][:]) # your train set labels

#     test_dataset = h5py.File('datasets/rui_dataset.h5', "r")
...
def load_data():
    ...
    with h5py.File('datasets/rui_dataset.h5', "r") as f:
